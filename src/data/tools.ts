...
export const tools: Tool[] = [
	...
	},
	{
		...
		sections: [
			...
			{
				heading: 'Zero down doesn\'t mean zero cash to close',
				body: [
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					'Stacked discounts do not add. A 20%-off sale on top of an already-30%-off clearance item works out to 20% off the *already-discounted* price, not 50% off the original price. $100 at 30% off is $70; take another 20% off that $70 and you get $56, a total discount of 44%, not 50%. CalcBadger\'s [Math hub](/category/math/) also has calculators for fractions and rounding.',
				],
			},
		],
		referenceTables: [
	...
	},
	{
		...
		sources: [
			...
			{
				label:
					'Haycock GB, Schwartz GJ, Wisotsky DH, "Geometric method for measuring body surface area: a height-weight formula validated in infants, children, and adults," Journal of Pediatrics 93(1):62-66 (1978)',
				url: 'https://doi.org/10.1016/s0022-3476(78)80601-5',
			},
			{
				label:
